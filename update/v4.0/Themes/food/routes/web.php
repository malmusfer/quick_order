...
Route::group(['namespace'=>'Amcoders\Theme\food\http\controllers','middleware'=>'web'],function(){
...
Route::group(['namespace'=>'Amcoders\Theme\food\http\controllers','middleware'=>['web','auth']],function(){
...
Route::group(['namespace'=>'Amcoders\Theme\food\http\controllers\Admin','middleware'=>['web','auth','admin'],'prefix'=>'admin/', 'as'=>'admin.'],function(){
...
Route::group(['as' =>'rider.','prefix'=>'rider','namespace'=>'Amcoders\Theme\food\http\controllers\Rider','middleware'=>['web','auth','rider','verified','riderapproval']],function(){
	// dashboard route
...
Route::group(['as' =>'rider.','prefix'=>'rider','namespace'=>'Amcoders\Theme\food\http\controllers\Rider','middleware'=>['web']],function(){
	// dashboard route
...
Route::group(['as' =>'author.','prefix'=>'author','namespace'=>'Amcoders\Theme\food\http\controllers\Author','middleware'=>['web','auth']],function(){
	// dashboard route
	Route::get('dashboard','DashboardController@dashboard')->name('dashboard');
...
Route::get('header/notify','Amcoders\Theme\food\http\controllers\WelcomeController@notify')->name('header.notify')->middleware('web');
