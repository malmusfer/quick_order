...
@endphp
<div class="order-details-area mt-150 mb-150">
	<div class="container">
		<div class="row">
			<div class="col-lg-7">
				<div class="card">
					<div class="card-body">
						<div class="table-responsive">
							...
							<div class="cart-bottom-details">
								<p><b>{{ __('Subtotal') }}: </b>  {{ strtoupper($currency->value) }}{{ $subtotal }}</p>
								@if($info->coupon_id != null)
								<p><b>{{ __('Discount Code') }}: </b>  {{ $info->coupon->title ?? '' }}</p>
								<p><b>{{ __('Discount') }}: </b>  {{ strtoupper($currency->value) }}{{ $info->discount }}</p>
								@endif
								<p><b>{{ __('Total') }}: </b>  {{ strtoupper($currency->value) }}{{ $info->total+$info->shipping }}</p>
							</div>
			...
			<div class="col-lg-5">
				<div class="card">
					...
					<div class="card mt-4">
						<div class="card-header text-center">
							<h5>{{ __('Restaurant Information') }}</h5>
						</div>
						<div class="card-body">
...
<script src="{{ theme_asset('food/public/js/frontend/order.js') }}"></script>
@endpush
@endif